        ...
        <div class="container-fluid">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <div class="nav navbar-left navbar-form">
                    <a href="https://github.com/fredsted/webhook.wromo.com" target="_blank"
                       style="margin-top: 7px"
                       class="btn btn-xs btn-link">
                        Github Page</a>
                    <a href="https://github.com/fredsted/webhook.wromo.com#donate" target="_blank"
                       style="margin-top: 7px"
                       class="btn btn-xs btn-link">
                        Donate</a>
        ...
        <div class="row">
            ...
            <div id="request" class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                ...
                <div id="tutorial" ng-show="!hasRequests || !hideTutorial">
                    ...
                    <p><strong>Webhook.wromo.com</strong>
                    ...
                    <p>
                        <a class="github-button" href="https://github.com/fredsted/webhook.wromo.com"
                           data-icon="octicon-star" data-show-count="true"
                           aria-label="Star fredsted/webhook.wromo.com on GitHub">Star on GitHub</a>
                        <a href="https://github.com/fredsted/webhook.wromo.com"
                    </p>
                </div>
